...
Current_gyrate_1 = a_data_container.get_gyrate().copy()
Current_multi_var_1 = a_data_container.get_multi_var().copy()
Current_mode_1 = a_data_container.get_mode().copy()
Current_tree_1 = a_data_container.get_tree().copy()
Current_var_1 = a_data_container.get_var().copy()
...
#print("\n", Current_multi_var)
#print(Current_multi_var_1, "\n")

#print("\n", Current_mode)
#print("\n", Current_mode_1, "\n")

print("\n", Current_tree, "\n")
print(Current_tree_1, "\n")
