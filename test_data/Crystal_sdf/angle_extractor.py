...
raw_data_sdf_angle = opener("C4X_11162.sdf")
raw_gyrate_file = opener("gyrateFile_C4X_11162")
raw_maestro_file = opener("torsions.sbc")
...
class angle_measure(object):
    ...
    def measure_torsion(self, a_ic_file_list, a_gyrate_list, a_gyrate_list_key, a_sdf_angle_list, a_wanted_torsion):
        """
...
a_writer = writer("Torsions.txt", results)
##
